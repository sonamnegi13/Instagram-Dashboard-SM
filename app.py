...
with st.sidebar:
    ...
    input_mode = st.radio("", ["Single Profile", "Competitor Comparison", "Hashtag Tracking"],
    ...
    date_range = st.selectbox("", ["Last 7 days","Last 30 days","Last 90 days"],
                              index=1, label_visibility="collapsed")
    days = {"Last 7 days":7,"Last 30 days":30,"Last 90 days":90}[date_range]

    st.markdown("**🎨 Chart Colors**")
    scheme = st.selectbox("", ["Magenta/Violet","Cyan/Teal","Amber/Gold"],
                          label_visibility="collapsed")
    COLORS = {
...
with tabs[0]:
    ...
    for col,(label,val,icon) in [(c,(l,v,i)) for c,(l,v,i) in reel_kpis]:
        with col:
...
with tabs[1]:
    ...
    if not eng_df_r.empty:
        ...
        import random as _r2; _r2.seed(42)
